...
## Objectif
Vérifier que le contrat de l'agent CORE-06 Documentation Lead est complet et valide.
...
3. Vérifier que `id` vaut "CORE-06".
4. Vérifier que `version` suit le format sémantique (x.y.z).
5. Vérifier que `tags` contient "core", "documentation", "knowledge".
